...
**Figure.** Example maximum-likelihood phylogenetic tree generated by SNPPhylogenomics. The tree was inferred from a core-genome SNP alignment using IQ-TREE2 and visualized with ETE3. Branch labels indicate ultrafast bootstrap support values.
